...
import type { Student } from '../../types'; // Import Student type for explicit narrowing
...
  const { submitComplaint } = useComplaints();
  ...
  // Helper function to safely get the department
  // This checks if the currentUser exists AND has the 'student' role.
  const getStudentDepartment = () => {
    if (currentUser && currentUser.role === 'student') {
      // TypeScript now knows currentUser is of type 'Student'
      return (currentUser as Student).department || ''; 
    }
    return '';
  };
  
...
    courseTitle: '',
    lecturerName: '',
    // FIX 1: Use the safe helper function to get department
...
    }
    ...
    // FIX 2: Type guard ensures currentUser is a Student for the rest of the function
...
        courseTitle: '',
        lecturerName: '',
        // FIX 3: Access studentUser.department now that the type is narrowed
